((factory)=>{ return factory() })(()=>{
	...
	var ParseRules =  {
		...
		ScalarDef: [word('open'), name('atom'), (0, RuleHelpers.list)('Directive')],
		ObjectTypeDef: [word('list'), name('atom'), (0, RuleHelpers.opt)('File'), (0, RuleHelpers.list)('Directive'), (0, RuleHelpers.p)('{'), (0, RuleHelpers.list)('FieldDef'), (0, RuleHelpers.p)('}')],
		File: [word('file'), (0, RuleHelpers.list)('NamedType')],
