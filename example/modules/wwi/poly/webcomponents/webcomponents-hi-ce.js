	...
	(function () {
		...
		function W(b) {
			function a(a, e) {
				Object.defineProperty(a, "innerHTML", {
					...
					set: function (a) {
						var f = this, d = void 0;
						g(this) && (d = [], t(this, function (b) {b !== f && d.push(b)}));
						e.set.call(this, a);
			...
			I ? n(Element.prototype, "attachShadow", function (b) {return this.__CE_shadowRoot = b = I.call(this, b)}) : console.warn("Custom Elements: `Element#attachShadow` was not patched.");
			if (v && v.get) a(Element.prototype, v); else if (w && w.get) a(HTMLElement.prototype, w); else {
				...
				b.s(function (b) {
					a(b, {
						enumerable: !0,
						configurable: !0,
						get: function () {return J.call(this, !0).innerHTML},
						set: function (b) {
		...
		function Z(b, a) {
			...
			d.before = function (d) {
				...
				e = f.filter(function (b) {return b instanceof Node && g(b)});
				a.I.apply(this, f);
			...
			d.replaceWith = function (d) {
				for (var f = [], e = 0; e < arguments.length; ++e)f[e - 0] = arguments[e];
				var e = f.filter(function (b) {return b instanceof Node && g(b)}), c = g(this);
				a.K.apply(this, f);
		...
		function Q(b, a, d) {
			a.prepend = function (a) {
				...
				e = c.filter(function (a) {return a instanceof Node && g(a)});
				d.C.apply(this, c);
		...
		(function (b) {
			...
			function c(a) {
				...
				if (c)for (var d = 0, e = b.length, m; d < e && (m = b[d]); d++)k(m, function () {--c || a()}); else a()
			}
			...
			function g(a) {return a.nodeType === Node.ELEMENT_NODE && "link" === a.localName && "import" === a.rel}
			
			function h() {
				var a = this;
				this.a = {};
				this.b = 0;
				this.f = new MutationObserver(function (b) {return a.m(b)});
			...
			var p = /(^\/)|(^#)|(^[\w-\d]*:)/, r = /(url\()([^)]*)(\))/g, t = /(@import[\s]+(?!url\())([^;]*)(;)/g,
				y = /(<link[^>]*)(rel=['|"]?stylesheet['|"]?[^>]*>)/g, q = {
					J: function (a, b) {
					...
					}, w: function (a, b) {return a && p.test(a) ? a : q.F(a, b)}, F: function (a, b) {
						if (void 0 === q.v) {
							q.v = !1;
							try {
			...
			h.prototype.o = function (a, b) {
				...
				v && (a = a.replace(y, function (a, b, c) {return -1 === a.indexOf("type=") ? b + " type=import-disable " + c : a}));
			...
			h.prototype.l = function () {for (var a = document.querySelectorAll("link[rel=import]"), b = a.length - 1, c; 0 <= b && (c = a[b]); b--)this.g(c)};
		...
		p.prototype.f = function (b) {return this.o.get(b)};
		p.prototype.L = function (b) {return this.m.get(b)};
		...
		p.prototype.l = function (b) {
			var a = this;
			this.i && t(b, function (b) {return a.g(b)})
		};
		...
		p.prototype.b = function (b) {
			var a = [];
			t(b, function (b) {return a.push(b)});
		...
		p.prototype.u = function (b) {
			if (void 0 === b.__CE_state) {
				...
				if (a) {
					...
					var d = a.constructor;
					try {try {if (new d !== b)throw Error("The custom element constructor did not produce the element being upgraded.");} finally {a.constructionStack.pop()}} catch (e) {
						throw b.__CE_state =
							2, e;
					}
					b.__CE_state = 1;
		...
		G.prototype.f = function () {this.b && this.b.disconnect()};
		...
		l.prototype.define =
			function (b, a) {
				...
				} catch (na) {return} finally {this.f = !1}
				this.a.M(b, {
					localName: b,
					constructor: a,
					connectedCallback: c,
		...
		l.prototype.get = function (b) {if (b = this.a.f(b))return b.constructor};
		...
		l.prototype.m =
			function (b) {
				this.j.f();
				var a = this.g;
				this.g = function (d) {return b(function () {return a(d)})}
			};
		...
		var z = window.Document.prototype.createElement, ha = window.Document.prototype.createElementNS,
			ga = window.Document.prototype.importNode, ia = window.Document.prototype.prepend,
			ja = window.Document.prototype.append, J = window.Node.prototype.cloneNode,
			y = window.Node.prototype.appendChild, R = window.Node.prototype.insertBefore,
			D = window.Node.prototype.removeChild, S = window.Node.prototype.replaceChild,
			...
			E = window.Element.prototype.getAttribute, K = window.Element.prototype.setAttribute,
			M = window.Element.prototype.removeAttribute, x = window.Element.prototype.getAttributeNS,
			L = window.Element.prototype.setAttributeNS,
			N = window.Element.prototype.removeAttributeNS, P = window.Element.prototype.insertAdjacentElement,
			X = window.Element.prototype.prepend, Y = window.Element.prototype.append,
			aa = window.Element.prototype.before, ba = window.Element.prototype.after,
			ca = window.Element.prototype.replaceWith, da = window.Element.prototype.remove, la = window.HTMLElement,
			w = Object.getOwnPropertyDescriptor(window.HTMLElement.prototype, "innerHTML"),
			O = window.HTMLElement.prototype.insertAdjacentElement, T = new function () {}, r = window.customElements;
		...
		(function () {
			...
			if (b && b.polyfillWrapFlushCallback) {
				...
				a.whenReady =
					function (b) {f(function () {c() ? a.whenReady(b) : b()})}
			}
